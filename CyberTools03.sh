...
figlet HORAS!! | lolcat
echo "Peringatan...Gunakan Tools Saya Dengan Bijak OK Lae :) " |lolcat
sleep 2

echo "=======================================" |lolcat
echo  "Welcome Tools    : Nicoleus F Sitorus      " |lolcat
echo  "Penyemangat  : Ijen M Sinaga             " |lolcat
echo  "My Youtube  : Adysitorusady     " |lolcat
...
echo "Created By : Nicoleus F Sitorus"  |lolcat
exit
fi
